...
type SettingsSpecResource struct {
	...
	AppApdexThreshold        *float64 `json:"appApdexThreshold" tf:"app_apdex_threshold"`
	EnableRealUserMonitoring *bool    `json:"enableRealUserMonitoring" tf:"enable_real_user_monitoring"`
	EndUserApdexThreshold    *float64 `json:"endUserApdexThreshold" tf:"end_user_apdex_threshold"`
