...
// +kubebuilder:rbac:groups=synthetics.newrelic.kubeform.com,resources=monitors,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=synthetics.newrelic.kubeform.com,resources=monitors/status,verbs=get;update;patch
...
func (r *MonitorReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &syntheticsv1alpha1.Monitor{}); err != nil {
			klog.Error(err, "unable to set up auditor", syntheticsv1alpha1.Monitor{}.APIVersion, syntheticsv1alpha1.Monitor{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&syntheticsv1alpha1.Monitor{}).
