...
// +kubebuilder:rbac:groups=infra.newrelic.kubeform.com,resources=alertconditions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=infra.newrelic.kubeform.com,resources=alertconditions/status,verbs=get;update;patch
...
func (r *AlertConditionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &infrav1alpha1.AlertCondition{}); err != nil {
			klog.Error(err, "unable to set up auditor", infrav1alpha1.AlertCondition{}.APIVersion, infrav1alpha1.AlertCondition{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&infrav1alpha1.AlertCondition{}).
