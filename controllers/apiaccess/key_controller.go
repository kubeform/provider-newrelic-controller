...
// +kubebuilder:rbac:groups=apiaccess.newrelic.kubeform.com,resources=keys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apiaccess.newrelic.kubeform.com,resources=keys/status,verbs=get;update;patch
...
func (r *KeyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &apiaccessv1alpha1.Key{}); err != nil {
			klog.Error(err, "unable to set up auditor", apiaccessv1alpha1.Key{}.APIVersion, apiaccessv1alpha1.Key{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&apiaccessv1alpha1.Key{}).
...
func (r *KeyReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &apiaccessv1alpha1.KeyList{}
