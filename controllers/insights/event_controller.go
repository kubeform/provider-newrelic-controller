...
// +kubebuilder:rbac:groups=insights.newrelic.kubeform.com,resources=events,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=insights.newrelic.kubeform.com,resources=events/status,verbs=get;update;patch
...
func (r *EventReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &insightsv1alpha1.Event{}); err != nil {
			klog.Error(err, "unable to set up auditor", insightsv1alpha1.Event{}.APIVersion, insightsv1alpha1.Event{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&insightsv1alpha1.Event{}).
