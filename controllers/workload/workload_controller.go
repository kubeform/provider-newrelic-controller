...
// +kubebuilder:rbac:groups=workload.newrelic.kubeform.com,resources=workloads,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=workload.newrelic.kubeform.com,resources=workloads/status,verbs=get;update;patch
...
func (r *WorkloadReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &workloadv1alpha1.Workload{}); err != nil {
			klog.Error(err, "unable to set up auditor", workloadv1alpha1.Workload{}.APIVersion, workloadv1alpha1.Workload{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&workloadv1alpha1.Workload{}).
