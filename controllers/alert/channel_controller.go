...
// +kubebuilder:rbac:groups=alert.newrelic.kubeform.com,resources=channels,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=alert.newrelic.kubeform.com,resources=channels/status,verbs=get;update;patch
...
func (r *ChannelReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Channel")
...
func (r *ChannelReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &alertv1alpha1.Channel{}); err != nil {
			klog.Error(err, "unable to set up auditor", alertv1alpha1.Channel{}.APIVersion, alertv1alpha1.Channel{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&alertv1alpha1.Channel{}).
...
func (r *ChannelReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Channel")
			return nil
		}
		...
		resourceList := &alertv1alpha1.ChannelList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Channel")
			return nil
		}
