...
// +kubebuilder:rbac:groups=alert.newrelic.kubeform.com,resources=policies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=alert.newrelic.kubeform.com,resources=policies/status,verbs=get;update;patch
...
func (r *PolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &alertv1alpha1.Policy{}); err != nil {
			klog.Error(err, "unable to set up auditor", alertv1alpha1.Policy{}.APIVersion, alertv1alpha1.Policy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&alertv1alpha1.Policy{}).
