module kubeform.dev/provider-newrelic-controller
...
require (
	...
	github.com/newrelic/terraform-provider-newrelic/v2 v2.30.2
	...
	kubeform.dev/provider-newrelic-api v0.3.1-0.20211028192239-841bec0fa15c
