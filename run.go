...
import (
	...
	newrelicscheme "kubeform.dev/provider-newrelic-api/client/clientset/versioned/scheme"
...
func init() {
	_ = newrelicscheme.AddToScheme(scheme)
...
func NewCmdRun(version string) *cobra.Command {
	cmd := &cobra.Command{
		Use:               "run",
		Short:             "Launch Kubeform newrelic Provider controller",
		DisableAutoGenTag: true,
		Run: func(cmd *cobra.Command, args []string) {
			klog.Infoln("Starting provider-newrelic-controller...")
			...
			mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
				...
				LeaderElectionID:       "newrelic.kubeform.com",
			})
			if err != nil {
